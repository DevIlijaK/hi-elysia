...
function setElementSize() {
    ...
    let blogGridLeftRightMarginPercentage = 0.1;
    let widthPercentage = 0.7;
    let heightPercentage = 0.2;
    let columnGapPercentage = 0;
    let rowGapPercentage = 0;
    ...
    if (windowWidth >= 1280) {
        ...
        columnGapPercentage = 0.1;
        rowGapPercentage = 0.05;
        ...
        columnGapPercentage = 0.1;
        rowGapPercentage = 0.05;
        blogGridLeftRightMarginPercentage = 0.15;
    }
    ...
    blogGrid.style.marginRight = `${windowWidth * blogGridLeftRightMarginPercentage}px`;
    blogGrid.style.marginLeft = `${windowWidth * blogGridLeftRightMarginPercentage}px`;
